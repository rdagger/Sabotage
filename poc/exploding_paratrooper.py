...
pygame.display.set_caption("Paratrooper Explosion")

# Load the images
jet = pygame.image.load("single_paratrooper.png")
sprite_sheet = pygame.image.load("explosion_paratrooper.png")
...
while running:
    ...
    if not exploding_pieces:
        screen.blit(jet, ((WIDTH - jet.get_width()) // 2, (HEIGHT - jet.get_height()) // 2))
